...
import com.google.common.base.Predicate;//OOH
import com.google.common.base.Predicates;//OOH
...
public class SwaggerConfig{
    ...
    public Docket produceApi(){
        return new Docket(DocumentationType.SWAGGER_2)
                       ...
                       .apiInfo(apiInfo())
                       .select()
                       .apis(RequestHandlerSelectors.basePackage("com.ealanta.swag.controllers"))
                       .paths(paths())
                       .build();
    }
    // Describe your apis
